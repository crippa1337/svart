cutechess-cli.exe \
    -engine name=$1 proto=uci cmd=C:/Users/casdc/Desktop/testing/$1.exe stderr=$1_stderr.txt \
    -engine name=$2 proto=uci cmd=C:/Users/casdc/Desktop/testing/$2.exe stderr=$2_stderr.txt \
